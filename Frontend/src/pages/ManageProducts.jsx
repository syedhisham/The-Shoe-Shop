...
const ManageProducts = () => {
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      {selectedProductId && <ProductUpdateForm productId={selectedProductId} onClose={handleCloseUpdateForm} />}
      {selectedProductIdForImage && <ProductUpdateImage productId={selectedProductIdForImage} onClose={handleClosrUpdateClick} />}
