...
const SignInPopup = ({ onClose, onNavigate }) => {
  return ReactDOM.createPortal(
    <div
      className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75 z-50 transition-opacity duration-300 animate-fadeIn"
    >
      <div
        className="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full transform transition-transform duration-300 animate-popup"
      >
        ...
        <div className="flex justify-end space-x-2">
          <button
            ...
            // Button for "OK" with hover scale animation
          >
            Sign In
          </button>
          <button
